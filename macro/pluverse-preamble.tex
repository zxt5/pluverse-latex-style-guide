...
\lstset{
  ...
  % If you want to use Latex commands inside lstlisting, and the escapte char % does not
  ...
  % escape char should be % be default. 
  % This is subject to change. Let's how this will work in the future.
  % escapeinside={(*@}{@*)},
  % ==== Font ====
  escapechar=\%,
